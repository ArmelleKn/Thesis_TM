...
subs = {'TRACK-P001', 'TRACK-P003','TRACK-P004','TRACK-P005', 'TRACK-P006', 'TRACK-P007', 'TRACK-P016', 'TRACK-P018', 'TRACK-P019', 'TRACK-P022', 'TRACK-P023', 'TRACK-P025', 'TRACK-P026', 'TRACK-P028', 'TRACK-P031', 'TRACK-P033', 'TRACK-P034', 'TRACK-P038', 'TRACK-P039', 'TRACK-P041', 'TRACK-P043', 'TRACK-P045', 'TRACK-P046',  'TRACK-P080', 'TRACK-P110', 'TRACK-P111', 'TRACK-P112', 'TRACK-P113', 'TRACK-P115', 'TRACK-P116', 'TRACK-P117', 'TRACK-P118', 'TRACK-P119', 'TRACK-P121', 'TRACK-P122', 'TRACK-P124', 'TRACK-P125', 'TRACK-P126', 'TRACK-P127', 'TRACK-P130', 'TRACK-P135', 'TRACK-P136', 'TRACK-P138', 'TRACK-P140', 'TRACK-P143', 'TRACK-P146', 'TRACK-P147', 'TRACK-P148'}
...
subs_old =  {'fMRI_OAB_1008', 'fMRI_OAB_1013','fMRI_OAB_2004','fMRI_OAB_2011','fMRI_OAB_2012','fMRI_OAB_2013','fMRI_OAB_2017'};
...
for pt = 1:numel(sub);
    ...
    % Save CORRELATION MAPS, also to call them back in the app again.
    % Important that there must be a map name 'Output' to save the
    % correlation maps in there
    ch0 = 'Output/';
    ch1 = sub(pt);
    ch1 = ch1{1};
    ch2 = 'Map_Pons_BN_Z_PD';
    %     ch2 = 'Map_Pons_BN_Z_HC';
    ch3 = '.mat';
...
% Make average_map using all_maps variable
average_map = squeeze(mean(all_maps,1));
%save('Map_Pons_BN_Z', "average_map");
%save('Map_Pons_BN_Z', "average_map");