...
#%%
rootdir= 'Z:/FHML_MHeNs/Urology_Div3/Thijs de rijk/TRACK/' #'/Volumes/Data/FHML/M7044/DATA/raw_data/'
...
#subj= ['TRACK-P077', 'TRACK-P078', 'TRACK-P079', 'TRACK-P080', 'TRACK-P081', 'TRACK-P082', 'TRACK-P083', 'TRACK-P084', 'TRACK-P085', 'TRACK-P086', 'TRACK-P088', 'TRACK-P089', 'TRACK-P090','TRACK-P091', 'TRACK-P092', 'TRACK-P093', 'TRACK-P094', 'TRACK-P095', 'TRACK-P096', 'TRACK-P097', 'TRACK-P098', 'TRACK-P099', 'TRACK-P100', 'TRACK-P101', 'TRACK-P102', 'TRACK-P103', 'TRACK-P104', 'TRACK-P105', 'TRACK-P106', 'TRACK-P107', 'TRACK-P108', 'TRACK-P109', 'TRACK-P110', 'TRACK-P111', 'TRACK-P112', 'TRACK-P113', 'TRACK-P114', 'TRACK-P115', 'TRACK-P116', 'TRACK-P117', 'TRACK-P118', 'TRACK-P119', 'TRACK-P120', 'TRACK-P121', 'TRACK-P122', 'TRACK-P123', 'TRACK-P124', 'TRACK-P125', 'TRACK-P126', 'TRACK-P127', 'TRACK-P128', 'TRACK-P129', 'TRACK-P130', 'TRACK-P131', 'TRACK-P132', 'TRACK-P133', 'TRACK-P134', 'TRACK-P135', 'TRACK-P136', 'TRACK-P137', 'TRACK-P138', 'TRACK-P139', 'TRACK-P140', 'TRACK-P141', 'TRACK-P142', 'TRACK-P143', 'TRACK-P144', 'TRACK-P145', 'TRACK-P146', 'TRACK-P147', 'TRACK-P148', 'TRACK-P149', 'TRACK-P150', 'TRACK-P151'] 
subj = ['TRACK-P001', 'TRACK-P002']
rootOUT= 'Z:/FHML_MHeNs/Urology_Div3/Thijs de rijk/TRACK/SB01/Out/'#'/Volumes/Data/FHML/M7044/DATA/BV/SB01/'
rootF='ASIA1_'


for isubj in subj:
    dirname=rootdir+isubj+'/'
    ifile=dirname+isubj+'_sequence_info.json'
    ...
    for vmr in idict:
        if 'anatomy_' in vmr:    
            ...
            if not os.path.exists(outdir + outfile + '.vmr'):
                ivmr=bv.create_vmr("DICOM", infile, idict[vmr]['number of volumes'], False, idict[vmr]['Rows'], idict[vmr]['Columns'], 2)
                #r = 1
                ivmr.save_as(outdir + outfile + '.vmr')
            
# The script assumes that the Objects sample data set has been installed in the "Documents/BVSampleData/RawData" folder

#GSG_dicoms = bv.sampledata_path + "GSGData_DICOM/sourcedata/sub-01/ses-04/anat/t1w-nd/"

#first_anat_dcm = GSG_dicoms + 'JudEck_20181128_BI_Exercises_sess4-0008-0001-00001.dcm'
#print(first_anat_dcm)

#doc_vmr = bv.create_vmr("DICOM", first_anat_dcm, 192, False, 256, 256, 2)
#doc_vmr.save_as("CG_3DT1MPR_FromScript.vmr")  # saves in current folder, use file path to store elsewhere

# doc_vmr.close()   # close when batch processing many files, skip for further processing
